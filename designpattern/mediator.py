...
class Mediator(ABC):
    """
    The Mediator interface declares a method used by componenets to notify the mediator about various events.
...
class BaseComponent:
    """
    The Base Component provides the base functionality of storing a 
